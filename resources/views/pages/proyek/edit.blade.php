                ...
                <div class="row">
                    <div class="col-md-6">
                            ...
                            <select class="form-select" id="customer_id" name="customer_id" required>
                                ...
                                @foreach ($customers as $customer)
                                    <option value="{{ $customer->id_customer }}"
                                        {{ old('customer_id', $proyek->customer_id) == $customer->id_customer ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="spbu_id" name="spbu_id" required>
                                <option value="">Pilih SPBU...</option>
                                @foreach ($spbus as $spbu)
                                    <option value="{{ $spbu->id }}"
                                        {{ old('spbu_id', $proyek->spbu_id) == $spbu->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control" id="harga_borongan" name="harga_borongan"
                                value="{{ old('harga_borongan', $proyek->harga_borongan) }}" required>
                        </div>
                        <div class="mb-3">
