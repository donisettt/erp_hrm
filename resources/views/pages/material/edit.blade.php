                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama"
                                value="{{ old('nama', $material->nama) }}" required>
                        </div>
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="supplier_id" name="supplier_id" required>
                                ...
                                @foreach ($suppliers as $supplier)
                                    <option value="{{ $supplier->id_supplier }}"
                                        {{ old('supplier_id', $material->supplier_id) == $supplier->id_supplier ? 'selected' : '' }}>
                                        {{ $supplier->nama }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="satuan" name="satuan"
                                value="{{ old('satuan', $material->satuan) }}" placeholder="Contoh: Pcs, Unit, Box"
                                required>
                        </div>
                        <div class="mb-3">
